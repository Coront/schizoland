AS.AddBaseClass( "mercenary", {
    ...
    icon = "models/Humans/Group03/male_09.mdl",
    color = Color( 255, 0, 0 ),
} )
...
AS.AddBaseClass( "scavenger", {
    ...
    icon = "models/props_junk/garbage128_composite001a.mdl",
...
AS.AddBaseClass( "engineer", {
    ...
    icon = "models/props_c17/tools_wrench01a.mdl",
...
AS.AddBaseClass( "scientist", {
    ...
    icon = "models/Items/HealthKit.mdl",
...
AS.AddBaseClass( "cultivator", {
    ...
    icon = "models/props_junk/watermelon01.mdl",
