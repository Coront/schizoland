...
AS.AddMapData( "pn_vault121_v1_p3", {
    MobMult = 1.5,
    NodeMult = 1.5,
    Load = {
        pos = Vector( 5238.1, 6717.08, 905.03 ),
        ang = Angle( 5.39, -112.57 ),
    },
    Spawns = {
        Vector( 2806.15, 6220.25, 596.03 ),
        Vector( 2729.67, 6220.65, 596.03 ),
        Vector( 2641.25, 6221.11, 596.03 ),
        Vector( 2641.52, 6272.58, 596.03 ),
        Vector( 2726.24, 6272.14, 596.03 ),
        Vector( 2814.92, 6271.7, 596.03 ),
    },
})
...
AS.AddMapData( "gm_boreas", {
    MobMult = 1,
    NodeMult = 1,
    Load = {
        pos = Vector( -5855.83, -7200.50, -6199.87 ),
        ang = Angle( -8.16, 44.32 ),
    },
    Spawns = {
        Vector( -8656.13, -15786.46, -10495.96 ),
        Vector( -8803.08, -15796.35, -10434.96 ),
        Vector( -8966.22, -15807.49, -10434.96 ),
        Vector( -8977.26, -15653.37, -10495.96 ),
        Vector( -8977.26, -15653.37, -10495.96 ),
        Vector( -8726.80, -15634.23, -10495.96 ),
    },
})