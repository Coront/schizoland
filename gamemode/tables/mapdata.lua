...
AS.AddMapData( "rp_pripyat_p", {
    ...
    Spawns = {
        Vector( -1969.25, -12255.06, 47 ),
        Vector( -1841.29, -12257.51, 47 ),
        Vector( -1860.05, -12415.23, 47 ),
        Vector( -1977.71, -12417.19, 47 ),
        Vector( -1977.86, -12525.43, 47 ),
    },
})

AS.AddMapData( "gm_atomic", {
    MobMult = 1.5,
    NodeMult = 1.5,
    Load = {
        pos = Vector( 7380.41, 3280.73, -10768.84 ),
        ang = Angle( 10.11, -145.58 ),
    },
    Spawns = {
        Vector( 5505.03, 2080.46, -12269.46 ),
        Vector( 5312.63, 2065.86, -12259.32 ),
        Vector( 5315.79, 1882.47, -12251.13 ),
        Vector( 5172.67, 1878.51, -12246.87 ),
        Vector( 5161.15, 2075.97, -12245.39 ),
    },
})