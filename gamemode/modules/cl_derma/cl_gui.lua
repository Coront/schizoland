...
function CharacterIcon( model, x, y, width, height, parent, callback, bgcol )
	...
	Icon:SetFOV(5.6)
	Icon:SetModel(model)
    local eyepos = IsValid( Icon.Entity ) and Icon.Entity:LookupBone("ValveBiped.Bip01_Head1") != " " and Icon.Entity:GetBonePosition(Icon.Entity:LookupBone("ValveBiped.Bip01_Head1")) or Vector(0,0,0)
