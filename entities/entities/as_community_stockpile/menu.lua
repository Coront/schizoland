...
function Stockpile.Open()
    ...
    local store = SimpleButton( panel, "Store", width, height, x, y, function()
        ...
        net.Start("as_stockpile_addresource")
            net.WriteEntity( ent )
            net.WriteInt( storescrap:GetValue(), 32 )
            net.WriteInt( storesmallp:GetValue(), 32 )
            net.WriteInt( storechem:GetValue(), 32 )
        net.SendToServer()
    end)
    ...
    local withdraw = SimpleButton( panel, "Withdraw", width, height, x, y, function() 
        ...
        net.Start("as_stockpile_takeresource")
            net.WriteEntity( ent )
            net.WriteInt( withdrawscrap:GetValue(), 32 )
            net.WriteInt( withdrawsmallp:GetValue(), 32 )
            net.WriteInt( withdrawchem:GetValue(), 32 )
        net.SendToServer()
    end)
end
