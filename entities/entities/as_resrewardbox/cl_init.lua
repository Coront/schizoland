...
hook.Add( "HUDPaint", "AS_ResRewardBox", function()
    local maxdist = 350
    ...
    if trace.Entity:GetClass() == "as_resrewardbox" then
        ...
        draw.SimpleTextOutlined( "Resource Reward Box", "TargetID", pos.x, pos.y, Color( col[1], col[2], col[3], opacity ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color( 0, 0, 0, opacity ) )
    end
end)