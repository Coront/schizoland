...
if CLIENT then
    SWEP.PrintName = "M82 Auto Xtreem 1337 "
    SWEP.Slot = 3
    SWEP.SlotPos = 0
	SWEP.YawMod = 0.1
...
SWEP.Sounds["reload"] = {[1] = {time = 1.3, sound = Sound("FAS2_M82.MagRelease")},
	[2] = {time = 1.8, sound = Sound("buttons/lever2.wav")},
	[3] = {time = 1.7, sound = Sound("MagPouch_AR")},
	[4] = {time = 3.1, sound = Sound("buttons/button6.wav")}}
	
SWEP.Sounds["bipod_reload"] = {[1] = {time = 0.8, sound = Sound("FAS2_M82.MagRelease")},
	[2] = {time = 0.9, sound = Sound("buttons/lever2.wav")},
	[3] = {time = 1.2, sound = Sound("MagPouch_AR")},
	[4] = {time = 2.4, sound = Sound("buttons/button6.wav")}}
	
SWEP.Sounds["bipod_reload_empty"] = {[1] = {time = 0.8, sound = Sound("FAS2_M82.MagRelease")},
	[2] = {time = 0.9, sound = Sound("buttons/lever2.wav")},
	[3] = {time = 1.2, sound = Sound("MagPouch_AR")},
	[4] = {time = 2.4, sound = Sound("buttons/button6.wav")},
	[5] = {time = 3.8, sound = Sound("buttons/lever3.wav")},
	[6] = {time = 4.1, sound = Sound("buttons/lever5.wav")}}
	
SWEP.Sounds["reload_nomen"] = {[1] = {time = 0.5, sound = Sound("MagPouch_AR")},
	[2] = {time = 1.1, sound = Sound("buttons/button11.wav")},
	[3] = {time = 1.2, sound = Sound("buttons/button2.wav")},
	[4] = {time = 1.75, sound = Sound("buttons/button6.wav")}}
	
SWEP.Sounds["reload_empty"] = {[1] = {time = 1.3, sound = Sound("FAS2_M82.MagRelease")},
	[2] = {time = 1.8, sound = Sound("buttons/lever2.wav")},
	[3] = {time = 1.7, sound = Sound("MagPouch_AR")},
	[4] = {time = 3.1, sound = Sound("buttons/button6.wav")},
	[5] = {time = 4.8, sound = Sound("buttons/lever3.wav")},
	[6] = {time = 5.15, sound = Sound("buttons/lever5.wav")}}
	
SWEP.Sounds["reload_empty_nomen"] = {[1] = {time = 0.5, sound = Sound("MagPouch_AR")},
	[2] = {time = 1.1, sound = Sound("buttons/button11.wav")},
	[3] = {time = 1.2, sound = Sound("buttons/button2.wav")},
	[4] = {time = 1.75, sound = Sound("buttons/button6.wav")},
	[5] = {time = 2.8, sound = Sound("buttons/lever3.wav")},
	[6] = {time = 3.1, sound = Sound("buttons/lever5.wav")}}
	
SWEP.Sounds["bipod_reload_nomen"] = {[1] = {time = 0.5, sound = Sound("FAS2_M82.MagRelease")},
	[2] = {time = 0.6, sound = Sound("buttons/button2.wav")},
	[3] = {time = 1, sound = Sound("MagPouch_AR")},
	[4] = {time = 1.5, sound = Sound("buttons/button6.wav")}}
	
SWEP.Sounds["bipod_reload_empty_nomen"] = {[1] = {time = 0.5, sound = Sound("FAS2_M82.MagRelease")},
	[2] = {time = 0.6, sound = Sound("buttons/button2.wav")},
	[3] = {time = 1.2, sound = Sound("MagPouch_AR")},
	[4] = {time = 1.5, sound = Sound("buttons/button6.wav")},
	[5] = {time = 2.5, sound = Sound("buttons/lever3.wav")},
	[6] = {time = 2.6, sound = Sound("buttons/lever5.wav")}}
	
SWEP.Sounds["bipod_dn"] = {[1] = {time = 0.8, sound = Sound("ambient/music/country_rock_am_radio_loop.wav")},
	[2] = {time = 1.65, sound = Sound("Bipod_Down")}}
	
SWEP.Sounds["bipod_up"] = {[1] = {time = 1.2, sound = Sound("ambient/materials/squeeker2.wav")}}
...
-- Firing related
SWEP.Shots = 1
SWEP.FireDelay = 60/2100
SWEP.Damage = 300
SWEP.FireSound = Sound("ambient/creatures/teddy.wav")

-- Accuracy related
SWEP.HipCone = 0.00001
